...
namespace Easy14_Programming_Language
{
    public class Program_OLD
    {
        ...
        static void Main_OLD(string[] args)
        {
            ...
            //    if (!UpdatesDisabled) updateChecker.checkLatestVersion();
            ...
            //                {
            //                    Program prog = new Program(); prog.ExternalComplieCode(command.Replace("/run", "").TrimStart());
            //                }
            ...
            //                        try
            //                        {
            //                            Program prog = new Program(); prog.ExternalComplieCode(command);
            //                        }
            //                        catch (Exception e)
            //                        {
            ...
            //                        Program prog = new Program();
            //                        prog.ExternalComplieCode(null, commandAsArray, 0);
            //                    }
            //                    else
            //                    {
            ...
            //        {
            //            Program prog = new Program();
            //            prog.ExternalComplieCode(command.Replace("/run", "").TrimStart());
            //        }
            //        else if (command.ToLower() == "/help")
            //        {
            //            string[] help_text =
